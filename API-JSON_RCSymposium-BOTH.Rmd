...
* Human version
    ...
    ![](https://upload.wikimedia.org/wikipedia/commons/d/d6/Uniform_Resource_Locator_%28URL%29_example.PNG)
    <!-- https://commons.wikimedia.org/wiki/File:Uniform_Resource_Locator_(URL)_example.PNG -->
    + client & server negotiate<br> 
    ![dramatization: good handshake](http://i.giphy.com/U2XboRuN89Idi.gif) 
...
![dramatization: confused about the protocol](http://i.giphy.com/MjkCYjM46NrrO.gif)
