...
Day One of [Duke Research Computing Symposium](https://rc.duke.edu/symposium-2017/)
...
The presentation materials were composed in *Rmarkdown* via *Rstudio* with `devtools::install_github("yihui/xaringan")`, stored in a *Github Repository*, Slides & Notebook served via *Github Pages*.  
...
![happy parsing dance](../images/result-happyDance.gif)
