...
publishers <- table(allBooks$publisher)                           # tally up each publisher's catalog
tbl_df(publishers)                                                # Display as a modern dataframe
```
...
4. What is the total number of pages of all books?
```{r bonus3}
